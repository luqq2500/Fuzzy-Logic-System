...
from transport.cli.adapter.cli_adapter import CreateVariableCLIAdapter, AddMembershipCLIAdapter, FormatExistingAntecedentCLIAdapter, GetVariableInfoByNameCLIAdapter
...
from transport.cli.strategy.cli_strategy import IUserStrategyCLI,UserCreateVariableCLI, UserPutVariableNameAddMembershipCLI, UserCreateVariableAddMembershipCLI
...
def setDependenciesReturnStrategies():
    ...
    get_var_name_add_membership = UserPutVariableNameAddMembershipCLI(get_variable_info_cli,add_mem_cli)
